...
_ACTION_CATEGORY: dict[str, str] = {
    ...
    "message.media_expired": "deletions",
    "media.deleted": "deletions",
    "media.retained": "messages",
    "media.retain_dropped": "messages",
    "contact.blocked": "accounts",
    "contact.unblocked": "accounts",
    "conversation.deleted": "deletions",
    "conversation.hidden": "deletions",
    ...
    "conversation.media_ttl_set": "settings",
    "tailscale.bound": "accounts",
    "tailscale.restored": "accounts",
    "tailscale.suspended": "accounts",
    "tailscale.unbound": "accounts",
    "tailscale.bind_conflict": "accounts",
    "tailscale.snapshot_refreshed": "settings",
    "conversation.anniversary_set": "settings",
    "admin.designated": "settings",
    "admin.device_trusted": "settings",
    "admin.device_cleared": "settings",
    "settings.media_ttl": "settings",
    "call.started": "calls",
    "call.ended": "calls",
}
